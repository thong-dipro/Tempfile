...
//   int? message;
//   int? cnt;
//   List<Thoitiet>? thoitiet;
//   City? city;

//   weather({this.cod, this.message, this.cnt, this.thoitiet, this.city});
...
//       thoitiet = <Thoitiet>[];
//       json['list'].forEach((v) {
//         thoitiet!.add(new Thoitiet.fromJson(v));
//       });
//     }
...
//     data['cnt'] = this.cnt;
//     if (this.thoitiet != null) {
//       data['list'] = this.thoitiet!.map((v) => v.toJson()).toList();
//     }
//     if (this.city != null) {
